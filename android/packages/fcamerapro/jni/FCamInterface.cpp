...
JNIEXPORT void JNICALL Java_com_nvidia_fcamerapro_FCamInterface_enqueueMessageForAutofocusSpot(JNIEnv *env, jobject thiz, jfloat x, jfloat y) {
	 ...
	 */
	const float spot[2] = {float(x), float(y)};
	LOG("! enqueueMessageForAutofocusSpot (%f, %f)", x, y);
	sAppData->requestQueue.produce(ParamSetRequest(PARAM_LOCAL_AF, &spot, sizeof(float)*2));
	// TODO TODO TODO
	// TODO TODO TODO
	// TODO TODO TODO
	// TODO TODO TODO
	    ...
	    while (!taskQueue.empty()) {
			...
			case PARAM_PRIV_FS_CHANGED:
				...
				case PARAM_LOCAL_AF:
					...
					autofocus.setSpot(((float *)taskData)[0], ((float *)taskData)[1]);
