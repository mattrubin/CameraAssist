...
/* UINT32 must hold at least unsigned 32-bit values. */

#ifndef XMD_H			/* X11/xmd.h correctly defines UINT32 */
typedef unsigned long UINT32;
#endif

/* RATIONAL is defined as in EXIF standard. */
...
/* SRATIONAL is defined as in EXIF standard. */

typedef struct exif_srational
{
    INT32 numerator;
    INT32 denominator;
} SRATIONAL;
