...
/* Data describing individual image in MPF file */

struct jpeg_mpf_image_info {
  UINT32 individual_image_number;
  UINT32 base_viewpoint;
  UINT32 image_size;
  UINT32 image_data_offset;
  SRATIONAL convergence_angle;
  SRATIONAL baseline_length;
  UINT16 dependent_image_1_entry;
  UINT16 dependent_image_2_entry;
  UINT32 mp_type_code;
  UINT8 representative_image_flag;
  UINT8 dependent_parent_image_flag;
  UINT8 dependent_child_image_flag;
};


/* MPF related information */

struct jpeg_mpf_app2_info {
  UINT32 number_of_images;
...
struct jpeg_decompress_struct {
  ...
  UINT16 X_density;		/* Horizontal pixel density */
  UINT16 Y_density;		/* Vertical pixel density */
  boolean saw_MPF_marker;	/* TRUE if MPF APP2 marker was found */
  struct jpeg_mpf_app2_info * mpf_info;	/* Info from MPF APP2 marker */
